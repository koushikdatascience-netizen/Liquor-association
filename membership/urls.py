...
urlpatterns = [
    ...
    path("office/", views.staff_dashboard, name="staff_dashboard"),
    path("office/dashboard/", views.staff_dashboard, name="staff_dashboard"),
    path("office/applications/", views.staff_applications, name="staff_applications"),
    path("office/applications/<int:pk>/", views.staff_application_detail, name="staff_application_detail"),
    path("office/applications/<int:pk>/action/", views.staff_application_action, name="staff_application_action"),
    path("office/payments/", views.staff_payments, name="staff_payments"),
    path("office/payments/<int:pk>/", views.staff_payment_detail, name="staff_payment_detail"),
    path("office/payments/<int:pk>/action/", views.staff_payment_action, name="staff_payment_action"),
    path("office/members/", views.staff_members, name="staff_members"),
    path("office/notifications/", views.staff_notifications, name="staff_notifications"),
    path("office/reports/", views.staff_reports, name="staff_reports"),
    path(
